...
if(mapbox) {
  ...
  Object(_mapbox__WEBPACK_IMPORTED_MODULE_2__["displayMap"])(locations)
}
...
const login = async (email, password) => {
  ...
  try {
    const res = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://localhost:8000/api/v1/users/login', {
      email,
      password
    })
    if (res.data.status === 'success'){
      ...
      Object(_alerts__WEBPACK_IMPORTED_MODULE_1__["showAlert"])('success', `Welcome to Natours ${firstName}!`)
      window.setTimeout(() => {
        location.assign('/')
      }, 1500)
    }
...
const logout = async () => {
  try {
    ...
    const res = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://localhost:8000/api/v1/users/logout')
    if(res.data.status === 'success'){
      Object(_alerts__WEBPACK_IMPORTED_MODULE_1__["showAlert"])('success', `You're logging out..`)
      window.setTimeout(() => {
